...
if [ "$(uname)" == "Darwin" ]; then
    binary_url="https://github.com/team-carepay/helm-s3/releases/download/v${version}/helm-s3_${version}_darwin_amd64.tar.gz"
elif [ "$(uname)" == "Linux" ] ; then
    binary_url="https://github.com/team-carepay/helm-s3/releases/download/v${version}/helm-s3_${version}_linux_amd64.tar.gz"
fi
...
checksum_url="https://github.com/team-carepay/helm-s3/releases/download/v${version}/helm-s3_${version}_checksums.txt"
